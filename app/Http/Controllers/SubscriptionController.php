...
class SubscriptionController extends Controller
{
     ...
     * @param array $columns Columnas a obtener en la consulta.
    ...
    private function getSubscriptionByEmail($email, $columns = ['*'])
    {
        ...
        // What: Select specific columns to avoid hydrating massive JSON/TEXT columns.
    ...
    public function subscribe(Request $request)
    {
        ...
        $existingSubscription = $this->getSubscriptionByEmail($email, ['id', 'email', 'status', 'external_reference', 'subscription_id']);
