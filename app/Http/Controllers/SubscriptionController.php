...
class SubscriptionController extends Controller
{
     ...
     * Obtiene una suscripción existente por correo electrónico.
     *
     * @param string $externalReference El correo electrónico del usuario.
     * @param array $columns
     * @return Subscription|null Retorna la suscripción si existe o null si no existe.
     */
    ...
    public function subscribe(Request $request)
    {
        ...
        // ⚡ Bolt: Memory optimization. Passing specific columns to avoid fetching massive 'response' TEXT column on checkout.
    ...
    public function reactivateSubscription($externalReference, $paymentType)
    {
        ...
        // ⚡ Bolt: Memory optimization. Passing specific columns to avoid fetching massive 'response' TEXT column on reactivation.
        $subscription =  $this->getSubscriptionByExternalReference($externalReference, ['id', 'email', 'status', 'external_reference', 'service_id', 'payment_type', 'subscription_id']);
