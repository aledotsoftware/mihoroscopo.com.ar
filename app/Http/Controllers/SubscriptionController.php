...
class SubscriptionController extends Controller
{
    ...
    private function getCurrencyByCountry($country)
    {
        ...
        // What: Replaced large string-based switch statement with a static map array.
        // Why: Static array maps provide O(1) constant-time lookups, which saves CPU cycles compared to O(N) evaluation in large switch blocks.
        // Impact: Improves performance slightly for high-concurrency loops and improves code readability.
        static $map = [
            'AR' => 'ARS',
            'BO' => 'BOB',
            'BR' => 'BRL',
