...
class SubscriptionController extends Controller
{
    ...
    private function getCurrencyByCountry($country)
    {
        ...
        // What: Replaced a large string-based switch statement with a static array map.
        // Why: Static array maps provide O(1) constant-time lookup, which is significantly faster
        //      than evaluating multiple switch cases, saving CPU cycles in tight loops or frequent calls.
        // Impact: Reduces CPU cycles and improves code readability.
        static $map = [
            'AR' => 'ARS',
            'BO' => 'BOB',
            'BR' => 'BRL',
