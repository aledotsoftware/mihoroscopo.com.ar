...
class SubscriptionController extends Controller
{
    ...
    private function getCurrencyByCountry($country)
    {
        ...
        // Why: Using static arrays provides an O(1) constant-time lookup for key-value mappings,
        //      avoiding redundant conditional branching cycles inside high-throughput functions.
        // Impact: Minor CPU cycle reduction and significantly improved readability.
        static $map = [
            'AR' => 'ARS',
            'BO' => 'BOB',
            'BR' => 'BRL',
