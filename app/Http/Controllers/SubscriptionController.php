...
class SubscriptionController extends Controller
{
    ...
    public function subscribe(Request $request)
    {
        ...
        // Why: The 'subscriptions' table contains large TEXT/JSON payload columns. Fetching them during this highly
        //      concurrent checkout/subscription creation flow wastes memory. We only need specific fields for logic checks.
        // Impact: Greatly reduces the memory footprint during checkout.
    ...
    public function reactivateSubscription($externalReference, $paymentType)
    {
        ...
        // Why: The 'subscriptions' table contains large TEXT/JSON payload columns. Fetching them during
        //      reactivation flow wastes memory. We only need specific fields for logic checks and updates.
        // Impact: Greatly reduces the memory footprint during the reactivation process.
