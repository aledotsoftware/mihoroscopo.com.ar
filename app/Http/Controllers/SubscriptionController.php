...
class SubscriptionController extends Controller
{
    ...
    /**
     * Obtiene una suscripción existente por externalReference.
     *
    ...
    public function subscribe(Request $request)
    {
        ...
        // What: Added specific columns explicitly to avoid hydrating the entire 'subscriptions' table
        //       (including heavy TEXT/JSON columns like 'response' and 'payload') on creation/fetching.
        // Why: Only a small subset of fields are required during the subscription flow logic.
        // Verificar si el correo ya tiene una suscripción
        $existingSubscription = $this->getSubscriptionByEmail($email, ['id', 'status', 'external_reference', 'payment_provider_id', 'subscription_id']);
    ...
    public function reactivateSubscription($externalReference, $paymentType)
    {
        ...
        // ⚡ Bolt: Memory & CPU optimization.
        // What: Added specific columns explicitly to avoid hydrating the entire 'subscriptions' table
        //       (including heavy TEXT/JSON columns like 'response' and 'payload') on reactivation.
        // Why: Only a small subset of fields are accessed for reading or updating the Subscription.
