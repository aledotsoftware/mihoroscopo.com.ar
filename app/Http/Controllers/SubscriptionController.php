...
class SubscriptionController extends Controller
{
    ...
    {
        // ⚡ Bolt Performance Optimization: Replace large switch statement with a static array map
        // This provides an O(1) constant-time lookup, saving CPU cycles in high-throughput endpoints.
        static $map = [
            'AR' => 'ARS',
            'BO' => 'BOB',
            'BR' => 'BRL',
