...
class SubscriptionController extends Controller
{
    ...
    public function subscribe(Request $request)
    {
        ...
        // What: Passed explicit columns to `getSubscriptionByEmail`.
        // Why: The 'subscriptions' table contains large TEXT/JSON columns ('response', 'payload') that consume
        //      significant memory when hydrated.
        // Impact: Reduces memory footprint per request.
    ...
    public function reactivateSubscription($externalReference, $paymentType)
    {
        ...
        // ⚡ Bolt: Memory optimization.
        // What: Passed explicit columns to `getSubscriptionByExternalReference`.
        // Why: The 'subscriptions' table contains large TEXT/JSON columns ('response', 'payload') that consume
        //      significant memory when hydrated.
        // Impact: Reduces memory footprint per request.
        $subscription =  $this->getSubscriptionByExternalReference($externalReference, ['id', 'email', 'external_reference', 'status']);
