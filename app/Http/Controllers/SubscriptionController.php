...
class SubscriptionController extends Controller
{
     ...
     *
     * @param string $externalReference La referencia externa.
     * @param array $columns Columnas a obtener
     * @return Subscription|null Retorna la suscripción si existe o null si no existe.
     */
    ...
    public function subscribe(Request $request)
    {
        ...
        // What: Passed specific columns to getSubscriptionByEmail.
        // Why: Avoids hydrating massive JSON/TEXT columns (like `response`) on the high-concurrency subscribe endpoint.
        // Impact: Reduces memory footprint per request and database I/O.
    ...
    public function reactivateSubscription($externalReference, $paymentType)
    {
        ...
        // ⚡ Bolt: Memory optimization.
        // What: Passed specific columns to getSubscriptionByExternalReference.
        // Why: Avoids hydrating massive JSON/TEXT columns (like `response`) when we only need to update basic status fields.
        // Impact: Reduces memory footprint and database I/O for reactivation.
