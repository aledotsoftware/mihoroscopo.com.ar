...
class SubscriptionController extends Controller
{
    ...
    private function getCurrencyByCountry($country)
    {
        ...
        // What: Replaced large string-based switch statement with a static array map.
        // Why: Switch statements on strings evaluate sequentially (O(N) time). A static array map
        //      provides an O(1) constant-time hash lookup, reducing CPU cycles on high-throughput flows.
        // Impact: Speeds up currency resolution and improves code readability.
        static $map = [
            'AR' => 'ARS',
            'BO' => 'BOB',
            'BR' => 'BRL',
