...
class SubscriptionController extends Controller
{
    ...
    public function subscribe(Request $request)
    {
        ...
        // What: Added select() array to getSubscriptionByEmail.
        // Why: The 'subscriptions' table contains large TEXT/JSON columns ('response', 'payload') that consume
        //      significant memory when hydrated. We only need specific fields for checkout flow logic.
        // Impact: Drastically reduces memory footprint and database overhead for the highly concurrent checkout flow.
    ...
    public function reactivateSubscription($externalReference, $paymentType)
    {
        ...
        // ⚡ Bolt: Memory optimization.
        // What: Added select() array to getSubscriptionByExternalReference.
        // Why: The 'subscriptions' table contains large TEXT/JSON columns ('response', 'payload') that consume
        //      significant memory when hydrated. We only need specific fields for reactivation flow logic.
        // Impact: Drastically reduces memory footprint and database overhead for the reactivation flow.
