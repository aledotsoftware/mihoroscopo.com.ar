...
class SubscriptionController extends Controller
{
    ...
    {
        // ⚡ Bolt: Array mapping optimization.
        // What: Replaced a large `switch` statement with a static array map.
        // Why: In PHP, large string-based `switch` statements evaluate sequentially (O(n) time complexity in the worst case).
        //      Using a static associative array map provides O(1) constant-time lookup.
        //      The `static` keyword ensures the array is only allocated in memory once per PHP process lifecycle,
        //      rather than being recreated on every method invocation.
        // Impact: Reduces CPU cycle overhead and slightly improves memory efficiency during high-throughput requests.
        static $map = [
            'AR' => 'ARS',
            'BO' => 'BOB',
            'BR' => 'BRL',
