...
class DiscordService
{
    ...
    public function sendDiscordMessage($message, $imageUrl = null)
    {
        ...
        // What: Wrapped the Discord API request inside Laravel's `defer()` helper.
        // Why: Calling external APIs synchronously blocks the main HTTP thread,
        //      significantly increasing response latency and risking timeouts
        //      for endpoints like webhooks that invoke this method.
        // Impact: Reduces HTTP latency on endpoints using this service.
