...
<body class="nav-fixed">
    <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
        ...
        <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="index.html">Mi Horóscopo</a>
        <!-- Navbar Search Input-->
            ...
            <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
                <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage"
                    ...
                    aria-expanded="false" aria-label="User profile"><img class="img-fluid"
                        src="{{ asset('/landing-v1/public/img/' . $subscription->signo . '.webp') }}" /></a>
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                    aria-labelledby="navbarDropdownUserImage">
                    <h6 class="dropdown-header d-flex align-items-center">
                        <img class="dropdown-user-img"
                            src="{{ asset('/landing-v1/public/img/' . $subscription->signo . '.webp') }}" />
                        <div class="dropdown-user-details">


                            @if ($subscription)
                                <div class="dropdown-user-details-name">{{ $subscription->name }}</div>
                                <div class="dropdown-user-details-email">{{ $subscription->email }}</div>
                            @else
                                <div class="dropdown-user-details-email">No se encontró la suscripción.</div>
                            @endif
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <div class="sidenav-menu-heading">mi Horóscopo</div>
                        <!-- Sidenav Link (Charts)-->
                ...
                <div class="sidenav-footer">
                    <div class="sidenav-footer-content">
                        ...
                        <div class="sidenav-footer-title">{{ $subscription->name }}</div>
            ...
            <footer class="footer-admin mt-auto footer-light">
                <div class="container-xl px-4">
                    <div class="row">
                        ...
                        <div class="col-md-6 small">Copyright &copy; 2024 Mi Horóscopo. All rights reserved.</div>
                        <div class="col-md-6 text-md-end small">

                            <a href="/blog/terminos-y-condiciones-de-servicio">Términos y Condiciones</a>
    ...
    <script src="{{ asset('assets/panel/js/litepicker.js') }}"></script>
