                                    ...
                                    @foreach ($articles as $article)
                                        <tr data-index="{{ $loop->index }}">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('articles.destroy', $article->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este artículo: {{ addslashes($article->title) }}?');">
                                                    @csrf
                                                    @method('DELETE')
