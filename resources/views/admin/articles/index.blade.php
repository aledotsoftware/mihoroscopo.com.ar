                                    ...
                                    @foreach ($articles as $article)
                                        <tr data-index="0">
                                            ...
                                            <td>
                                                ...
                                                <form action="/admin/articles/{{ $article->id }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este artículo?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-datatable btn-icon btn-transparent-dark border-0 bg-transparent" aria-label="Eliminar artículo: {{ $article->title }}"><svg xmlns="http://www.w3.org/2000/svg" width="24"
