                                    ...
                                    @foreach ($articles as $article)
                                        <tr data-index="0">
                                            ...
                                            <td>
                                                ...
                                                <form action="" method="POST" style="display:inline;" data-title="{{ $article->title }}" onsubmit="return confirm('¿Estás seguro de que deseas eliminar el artículo \'' + this.dataset.title + '\'?');">
                                                    @csrf
                                                    @method('DELETE')
