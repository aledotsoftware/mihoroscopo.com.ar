                                        ...
                                        <tr data-index="0">
                                            ...
                                            <td>
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark me-2"
                                                    href="{{ route('admin.articles.edit', $article->id) }}" aria-label="Editar artículo"><svg
                                                ...
                                                <form action="{{ route('admin.articles.destroy', $article->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este artículo?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-datatable btn-icon btn-transparent-dark border-0 p-0" aria-label="Eliminar artículo"><svg xmlns="http://www.w3.org/2000/svg" width="24"
