                                        ...
                                        <tr data-index="0">
                                            ...
                                            <td class="d-flex align-items-center gap-2">
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark"
                                                    href="/admin/articles/{{ $article->id }}/edit" aria-label="Editar artículo: {{ $article->title }}">
                                                ...
                                                <form action="{{ route('admin.articles.destroy', $article->id) }}" method="POST" style="display:inline; margin: 0;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este artículo: {{ addslashes($article->title) }}?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-datatable btn-icon btn-transparent-dark border-0 bg-transparent p-0" aria-label="Eliminar artículo: {{ $article->title }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                            class="feather feather-trash-2" aria-hidden="true">
