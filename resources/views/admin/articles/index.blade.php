                                    ...
                                    @foreach ($articles as $article)
                                        <tr data-index="0">
                                            ...
                                            <td>
                                                ...
                                                <form action="/admin/articles/{{ $article->id }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar el artículo: ' + @js($article->title) + '?');">
                                                    @csrf
                                                    @method('DELETE')
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="/admin/articles/{{ $article->id }}/edit" aria-label="Editar artículo: {{ $article->title }}">Editar</a>
                <form action="/admin/articles/{{ $article->id }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar el artículo: ' + @js($article->title) + '?');">
                    @csrf
                    @method('DELETE')
