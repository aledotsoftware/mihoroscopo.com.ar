                                        ...
                                        <tr data-index="0">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <form action="/admin/articles/{{ $article->id }}" method="POST" style="display:inline; margin: 0;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este artículo: {{ addslashes($article->title) }}?');">
                                                        @csrf
                                                        @method('DELETE')
