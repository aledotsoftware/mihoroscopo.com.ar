                                    ...
                                    @foreach ($articles as $article)
                                        <tr data-index="0">
                                            ...
                                            <td>
                                                ...
                                                <form action="/admin/articles/{{ $article->id }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar {{ addslashes($article->title) }}?');">
                                                    @csrf
                                                    @method('DELETE')
