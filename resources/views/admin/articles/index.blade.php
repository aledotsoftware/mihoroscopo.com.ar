                                ...
                                <tbody>
                                    ...
                                    @foreach ($articles as $article)
                                        <tr data-index="0">
                                            ...
                                            <td>
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="/admin/articles/{{ $article->id }}/edit" aria-label="Editar artículo: {{ $article->title }}">
                                                ...
                                                <form action="{{ route('admin.articles.destroy', $article->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este artículo: ' + @js($article->title) + '?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-datatable btn-icon btn-transparent-dark" aria-label="Eliminar artículo: {{ $article->title }}">
