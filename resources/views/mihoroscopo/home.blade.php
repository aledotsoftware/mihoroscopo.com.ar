                ...
                <div class="owl-features owl-carousel">
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/aries') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/tauro') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/geminis') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/cancer') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/leo') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/virgo') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/libra') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/escorpio') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/sagitario') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/capricornio') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/acuario') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="down-content">
                            ...
                            <a href="{{ asset('blog/piscis') }}"><i class="fa fa-link"></i></a>
                        </div>
                    </div>
                </div>
            </div>
