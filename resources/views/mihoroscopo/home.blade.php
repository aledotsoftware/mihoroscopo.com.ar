        ...
        <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="plan-item bg-light rounded text-center">
                ...
                <div class="text-start p-5">
                    ...
                    <a href="/landing" class="btn btn-light rounded-pill py-2 px-5" role="button" aria-label="Elegir plan Diario">Elegir Plan</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
            <div class="plan-item bg-light rounded text-center">
                ...
                <div class="text-start p-5">
                    ...
                    <p><i class="fas fa-check text-success me-1" aria-hidden="true"></i> Acceso a Contenido Exclusivo</p>
                    <p><i class="fas fa-check text-success me-1" aria-hidden="true"></i> Notificaciones Personalizadas</p>
                    <a href="/landing" class="btn btn-light rounded-pill py-2 px-5" role="button" aria-label="Elegir plan Semanal">Elegir Plan</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
            <div class="plan-item bg-light rounded text-center">
                ...
                <div class="text-start p-5">
                    ...
                    <p><i class="fas fa-check text-success me-1" aria-hidden="true"></i> Acceso a Contenido Exclusivo</p>
                    <p><i class="fas fa-check text-success me-1" aria-hidden="true"></i> Notificaciones Personalizadas</p>
                    <a href="/landing" class="btn btn-light rounded-pill py-2 px-5" role="button" aria-label="Elegir plan Mensual">Elegir Plan</a>
                </div>
            </div>
        </div>
    </div>
