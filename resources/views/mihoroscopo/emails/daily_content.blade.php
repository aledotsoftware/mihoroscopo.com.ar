...
<head>
    ...
    <style type="text/css">
        ...
        .container {
            ...
            /* Fondo de la caja principal */
            border-radius: 8px;
            overflow: hidden;
            border: 1px solid #dee2e6;
            /* Borde de la caja principal */
        }
        ...
        .content h1 {
            font-size: 24px;
            color: #212529;
            /* Color del texto del encabezado principal */
        }
        ...
        .horoscope h2 {
            color: #5b03e4;
            /* Color del encabezado del horóscopo */
            text-align: center;
            font-size: 22px;
        }
        ...
        .footer a {
            color: #c03afe;
            /* Color del enlace en el pie de página */
            text-decoration: none;
        }
    </style>
</head>
...
<body>
    ...
    <table class="container">
        ...
        @if (in_array($content['subscription_payment_type'], ['gaia', 'pending']))        
        <tr>
            <td class="content">
        ...
        <tr>
            <td class="content">
                <h2>Guía Astral</h2>
                <div class="horoscope">
                    <p>{{ $content['content_astral_guide'] }}</p>
                </div>
            </td>
        </tr>
        @endif
        ...
        <tr>
            <td class="content">
                <h2>Consejo Diario</h2>
                <div class="horoscope">
                    <p>{{ $content['content_daily_astro_advice'] }}</p>
                </div>
            </td>
        </tr>
        @endif
        ...
        <tr>
            <td class="content">
                <h2>Amor</h2>
                <div class="horoscope">
                    <p>{{ $content['content_love_prediction'] }}</p>
                </div>
            </td>
        </tr>
        @endif
        ...
        <tr>
            <td class="content">
                <h2>Ritual del Amor</h2>
                <div class="horoscope">
                    <p>{{ $content['content_love_ritual'] }}</p>
                </div>
            </td>
        </tr>
        @endif
        ...
        <tr>
            <td class="content">
                <h2>Ritual Lunar</h2>
                <div class="horoscope">
                    <p>{{ $content['content_lunar_ritual'] }}</p>
                </div>
            </td>
        </tr>
        @endif
        ...
        <tr>
            <td class="content">
                <h2>Ritual de Prosperidad</h2>
                <div class="horoscope">
                    <p>{{ $content['content_prosperity_ritual'] }}</p>
                </div>
            </td>
        </tr>
        @endif
        ...
        <tr>
            <td class="content">
                <h2>Compatibilidad Zodiacal</h2>
                <div class="horoscope">
                    <p>{{ $content['content_zodiac_compatibility'] }}</p>
                </div>
            </td>
        </tr>
        @endif
