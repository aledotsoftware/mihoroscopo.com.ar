...
//         $extradataHoroscope->save();
            ...
            fetch(apiUrl, {
                ...
                .catch(error => {
                    ...
                    // Mostrar error amigable al usuario en lugar de recargar silenciosamente
                    showModal('Ocurrió un error al procesar tu solicitud. Por favor, intenta de nuevo.', btnConfirmName);
                });
